...
<style type="text/css">
#nav ul .links a {margin-top:0px;border-top:3px solid #fff;color:#fff;}
#sidemenu ul .links a {color:#FFFFFF;}
</style>
</head>
		...
		<?php include($_SERVER['DOCUMENT_ROOT'].'/includes/layout/top-navigation.php'); ?>
			...
			<div id="content_holder">
				<div id="content_full">
					...
					<div id="table">
						<?php include($_SERVER['DOCUMENT_ROOT'].'/includes/html/links.html'); ?>
					</div>
					<table width='100%'>
					<tr><td align='center'>
